# Awakelab-Prueba6-AppWeb-Consultora
<h3> App Web bajo Spring Framework MVC que gestiona requerimientos de una consultora de prevención de accidentes. </h3>

<h4> Conocimeintos aplicados </h4>
