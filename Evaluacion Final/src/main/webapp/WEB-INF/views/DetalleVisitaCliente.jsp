...
<body>
    <div class="maestro">
        ...
        <div class="subMaestro">
            <div class="subModal">
                <p> <b> Asunto visita: <c:out value="${visita.getEvento().getAsunto()}" /></b>                
                </p>
            </div>
        ...
        <div class="detalleModal">
            <table class="tablaNoDinamica">
                ...
                <tr>
                    ...
                    <td>
                        <p>
                           <c:out value="${visita.getEvento().getLugar().getDireccion()}" />
                        </p>
                    </td>
                </tr>   
                 ...
                 <tr>
                    ...
                    <td>
                    <form:form action="${pageContext.request.contextPath}/Cliente/cumplimientoVisita/${id_cl}.html" method="POST" class="formContacto" >
