...
<style>      
    ...
    <body>
       ...
       <div class="formEdit">
            ...
            <form:form action="${pageContext.request.contextPath}/Admin/cambioContrasena.html" method="POST" class="formContacto" id="formSetKey"  >
                    <form:input type="hidden" path="id_usuario" value="${id_us}" />
                    <div class="separadorForm"><p> Cambio contraseña cliente ID: ${id_cl} </p></div>
