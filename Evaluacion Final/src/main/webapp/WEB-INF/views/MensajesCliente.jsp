...
<main id="contenido">
            ...
            <div class="col-3 cont-text-pag-tabla" >      
				<div id="tabs">
				  <ul>
				    <li><a href="${pageContext.request.contextPath}/Cliente/todosLosMensajesNoLeidos/${idU_cliente}.html"><span>No leídos</span></a></li>
				    <li><a href="${pageContext.request.contextPath}/Cliente/todosLosMensajes/${idU_cliente}.html"><span>Recibidos</span></a></li>
				    <li><a href="${pageContext.request.contextPath}/Cliente/mensajesEnviados/${idU_cliente}.html"><span>Enviados</span></a></li>
				  </ul>
					  <div id="noLeidos">    
					  </div>
					  <div id="leidos">  
             ...
             <div class="col-4 cont-text-pag-tabla">
                ...
                <form:form action="generaMensaje.html" method="POST" class="formContacto">
