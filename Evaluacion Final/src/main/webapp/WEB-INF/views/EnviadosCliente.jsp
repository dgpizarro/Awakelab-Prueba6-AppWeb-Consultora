                            ...
                            <c:forEach var="n" items="${newsP}">
                                <tr>
                                    ...
                                    <td style="text-align: center; font-size: 1.6em; ">
                                       <a class="modal2" href="${pageContext.request.contextPath}/Cliente/irDetalleEnviado/${n.getId_mensaje()}.html" ><i class="fas fa-plus-circle" style="color:rgb(9, 83, 219);"></i></a>
                                    </td>                                   
                                </tr>
                            </c:forEach>
                        </tbody>
