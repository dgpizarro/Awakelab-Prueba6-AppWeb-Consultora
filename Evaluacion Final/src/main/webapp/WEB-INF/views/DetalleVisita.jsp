...
<body>
	<div class="maestro">
		...
		<div class="tituloModalMensaje">
			<h2>
				Asunto:  <c:out value="${visita.getEvento().getAsunto()}" />
			</h2>
		</div>
		<div class="subMaestro">
			<div class="subModal">
				...
				<p>
					<b> Lugar: <c:out
							value="${visita.getEvento().getLugar().getDireccion()}" />
					</b>
				</p>
		...
		<div class="detalleModal">
			<table class="tablaNoDinamica">
						...
						<div class="fechaModal">
							...
							<p>
								<fmt:formatDate pattern="dd-MM-yyyy"
									value="${visita.getEvento().getFecha_inicio()}" />
				...
				<tr>
					...
					<td>
						<div class="fechaModal">
							...
							<p>
								<fmt:formatDate pattern="dd-MM-yyyy"
									value="${visita.getEvento().getFecha_fin()}" />
				...
				<tr>
					...
					<td>
						<p>
							<c:out value="${visita.getEvento().getHora()}" />
						</p>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<p>
							<c:out value="${visita.getEvento().getCumplimiento()}" />
						</p>
					</td>
				</tr>
				<tr>
			...
			<input type="hidden" id="direccion" value="${visita.getEvento().getLugar().getDireccion()}" />
